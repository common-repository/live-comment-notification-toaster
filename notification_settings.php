...
<p><?php echo _e('Select your post types for applying toast notification.','toast_notification');?></p>
...
<tr>
<th><?php echo _e('Notification visible to:','toast_notification');?></th>
<td><input type="radio" name="auth_visible" value="1" <?php if($auth_visible==1){?> checked="checked" <?php }?>> All Users/Visitors<br/>   
<input type="radio" name="auth_visible" value="0" <?php if($auth_visible==0){?> checked="checked" <?php }?>> Only Author</td>
</tr>
<tr>
